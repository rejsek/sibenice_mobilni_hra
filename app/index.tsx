  ...
  return (
    <View className="flex-1 bg-gray-800 px-6 items-center justify-center">
      <View className="w-full max-w-[400px] items-center">
        <View className="border-4 border-gray-600 rounded-xl px-10 py-6 mb-10 shadow-lg shadow-black w-full">
          <Text
            style={{
              fontSize: 44,
              fontWeight: "bold",
        ...
        <View className="bg-gray-700 px-6 py-4 rounded-lg shadow-md mb-10 w-full">
        ...
        <TouchableOpacity
          ...
          className="bg-green-600 px-6 py-4 rounded-xl shadow-lg shadow-black mb-6 w-full active:bg-green-800"
        >
